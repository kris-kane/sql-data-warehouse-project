...
-----------------------------------------------------------
Purpose: Performs the ETL (Extract, Transform, Load) process to populate the
'silver' schemas from the 'bronze' schema.
